...
export class ContactsRepository implements CreateContactRepository, UpdateContactRepository, LoadContactByIdRepository {
  create(input: CreateContactRepository.Params): Promise<CreateContactUseCase.Result> {
