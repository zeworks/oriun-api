...
import { LoadRoleByKeyUseCase, LoadRoleByKeyUseCaseFunction } from "@/domain/usecases/roles/load-role-by-key";

export class DbLoadRoleByKey implements LoadRoleByKeyUseCase {

  constructor(
    private readonly loadRoleByKey: LoadRoleByKeyRepository
  ) {}
