...
test("Should update company with success", async () => { 
  ...
  const updateContactUseCase = new DbUpdateContact(contactsRepository, contactsRepository)
  const updateCompanyUseCase = new DbUpdateCompany(companiesRepository, companiesRepository);
  ...
  const updateCompanyController = new UpdateCompanyController(makeUpdateCompanyValidation(), makeCreateContactValidation(), createContact, updateContactUseCase, updateCompanyUseCase)
