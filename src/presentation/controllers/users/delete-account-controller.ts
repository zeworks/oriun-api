...
export class DeleteAccountController implements Controller<DeleteAccountController.Params, DeleteAccountController.Result> {
  constructor(
    private readonly deleteAccount: DeleteAccountUseCase,
  ) { }

  execute: ControllerProtocol<DeleteAccountController.Params, DeleteAccountController.Result> = async (request) => {
    // if no user id sent
    if (!request?.id) {
