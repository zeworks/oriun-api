...
export default {
  Query: {
    ...
    company: (_: any, args: any, context: any) => apolloControllerAdapter(new AclDecorator(makeLoadCompanyByIdController(), PermissionKey.CompaniesView), args, context),
  },
  Mutation: {
    ...
    deleteCompany: (_: any, args: any, context: any) => apolloControllerAdapter(new AclDecorator(makeDeleteCompanyController(), PermissionKey.CompaniesDelete), args, context),
  }
}
