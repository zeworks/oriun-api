...
export default {
	Query: {
		departments: (_: any, args: any, context: any) =>
			apolloControllerAdapter(
				new AclDecorator(
					makeLoadDepartmentsController(),
					PermissionKey.DepartmentsView
				),
				args,
				context
			),
		department: (_: any, args: any, context: any) =>
			apolloControllerAdapter(
				new AclDecorator(
					makeLoadDepartmentByIdController(),
					PermissionKey.DepartmentsView
				),
				args,
				context
	...
	Mutation: {
		createDepartment: (_: any, args: any, context: any) =>
			apolloControllerAdapter(
				new AclDecorator(
					makeCreateDepartmentController(),
					PermissionKey.DepartmentsCreate
				),
				args.input,
				context
			),
		updateDepartment: (_: any, args: any, context: any) =>
			apolloControllerAdapter(
				new AclDecorator(
					makeUpdateDepartmentController(),
					PermissionKey.DepartmentsUpdate
				),
				args,
				context
			),
		deleteDepartment: (_: any, args: any, context: any) =>
			apolloControllerAdapter(
				new AclDecorator(
					makeDeleteDepartmentController(),
					PermissionKey.DepartmentsDelete
				),
				args,
				context
			),
